...
const LaunchButton = () => {
  ...
  return (
    <motion.button
      className="relative group px-12 py-6 bg-dark-secondary rounded-full overflow-hidden scale-125 cursor-pointer z-10"
    ...
    >
      ...
      <div className="relative flex items-center space-x-4">
        <span className="text-cyber-primary font-bold text-2xl tracking-wider">
          LAUNCH PROJECT
        </span>
        <div className="relative w-8 h-8">
          ...
          {isHovered ? (
            <motion.div
              ...
              exit={{ y: 60, scale: 0.8, opacity: 0, rotate: -45 }}
              className="absolute text-3xl text-cyber-primary"
            >
              <IoRocketSharp />
            </motion.div>
            ...
            <motion.div
              initial={{ y: 60, scale: 0.8, opacity: 0, rotate: -45 }}
              animate={{ y: 60, scale: 0.8, opacity: 0, rotate: -45 }}
              className="absolute text-3xl text-cyber-primary"
            >
              <IoRocketSharp />
            </motion.div>
      ...
      <motion.div
        ...
        style={{
          ...
          background:
            "linear-gradient(to top, var(--cyber-primary), transparent)",
...
export default function Hero() {
  ...
  return (
    <div
      ref={containerRef}
      className="relative min-h-screen bg-dark-primary overflow-hidden"
    >
      <SpaceElements />
      ...
      >
        ...
        >
          Embark on a journey through digital innovation and cutting-edge
          technology
        </motion.p>
        ...
        {/* Orbital Ring */}
        <div
          className="absolute w-[150%] h-[150%] border border-cyber-primary/20 rounded-full animate-spin-slow"
          style={{ animationDuration: "20s" }}
        />
        <div
          className="absolute w-[140%] h-[140%] border border-cyber-secondary/20 rounded-full animate-spin-slow"
          style={{ animationDuration: "15s" }}
        />
        <div
          className="absolute w-[130%] h-[130%] border border-cyber-primary/20 rounded-full animate-spin-slow"
